        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplicateFileUrl = table.Column<string>(type: "text", nullable: true),
                    ReplicatePredictionId = table.Column<string>(type: "text", nullable: true),
                    Scenario = table.Column<string>(type: "text", nullable: false),
                    OutputUrl = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
                    CreditDeducted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_StoreTransactionId",
                table: "Purchases",
